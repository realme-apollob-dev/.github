...
<manifest>
  ...
  <project remote="apollob-dev" path="device/mediatek/sepolicy_vndr" name="android_device_mediatek_sepolicy_vndr" />
  <project remote="apollob-dev" path="packages/apps/RealmeParts" name="android_packages_apps_RealmeParts" />
</manifest>
```
